...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	...
	<div
		...
		<h2>Imprimer des Ressources</h2>
	</div>
		
	<%= request.getAttribute("ressource-list") %>
	
	<a href="<%=request.getContextPath()%>/PanelController?action=print&resList=done"
	class="w-75 btn btn-lg btn-secondary fw-bold border-white bg-white" style="margin-left: 10%">Imprimer</a>
