...
<body class="bg-light d-flex h-100">
	...
	<div class="d-flex flex-column flex-shrink-0 p-3 text-black bg-white"
		...
		<ul class="nav nav-pills flex-column mb-auto">
			...
			<li><a href="<%=request.getContextPath()%>/admin/software"
				class="nav-link active"> Logiciels </a></li>
		</ul>
	...
	<main style="padding-left: 15%; width: 100%;">
		<section class="jumbotron text-center">
			<div class="container">
				<h1 class="jumbotron-heading">Tableau des logiciels</h1>
				...
				<form id="table-filter" style="margin-top: 5%;" class="form-inline"
					method="GET" action="/admin/software">
					...
					<div class="d-flex justify-content-end col-9">
						<a href="/admin/new-software" class="btn btn-success">Créer un logiciel</a>
					</div>
				...
				<table style="margin-top: 1%;"
					...
					<tbody>
						...
						for (List<String> tuple : li) {
							...
							int price = Integer.valueOf(tuple.get(2));
						%>
