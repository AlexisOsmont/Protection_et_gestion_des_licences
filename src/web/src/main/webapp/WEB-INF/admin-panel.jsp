	...
	<div class="d-flex flex-column flex-shrink-0 p-3 text-black bg-white"
		...
		<ul class="nav nav-pills flex-column mb-auto">
			<li><a href="#" class="nav-link active position-relative">
					Notifications <%
			List<Licence> lu = (List<Licence>) request.getAttribute("notification-list");
			int size = lu.size();
			if (size > 0) {
			%> <span
		...
		<div class="album py-5 bg-light">
			<div class="container">
				<div class="row">
					...
					<%
					List<Licence> li = (List<Licence>) request.getAttribute("notification-list");
					for (Licence licence : li) {
					%>

					<div class="col-md-4"
						style="border: 3px solid transparent; border-radius: 5px;">

						<a href="/licence/<%=licence.getId()%>"> 
