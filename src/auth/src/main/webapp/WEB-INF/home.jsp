			...
			<div class="card border-0 col-sm-9 col-lg-7">
				<div class="card-body" style="padding: 30% 1rem">
					...
					if (logged != null && logged) { %>
						<h1 class="fw-bold mb-4">Bienvenu <%= session.getAttribute("username")%> !</h1>
						<p>Votre adresse mail est  : <%= session.getAttribute("mail")%> </p>
					<%} else {%>
						<h1 class="fw-bold mb-4">Bienvenu !</h1>
						<p>Vous pouvez connecter afin d'accéder à votre compte.</p>
					<%}%>
