...
namespace HardwareHash
{
    internal class MachineHardware
    {
        ...
        public static string getHardwareId(Dictionary<string, bool> components)
        {
            return getHardwareId(components[MAC], components[BASE_BOARD],
                    components[HARD_DRIVE], components[BIOS], components[PROC]);
        }
