...
\begin{table}[!h]
        ...
        \begin{tabular}{|m{1cm}|
            ...
            \hline
            \multicolumn{5}{|c|}{
                \textbf{Procédure n° }Procédure n°4 - Test CA5
            } \\
            \hline
            N° & Actions & Résultats attendus & Exig. & OK / NOK \\
            \hline      % start of the array
            1 & le testeur démarre le logiciel protégé sur la machine
                cible. 
              & Un menu appraît avec un champ de texte permettant d'écrire
                le chemin du fichier de licence, un bouton  une boîte de dialogue 
              & Exigences vérifiées & \\
            \hline
            2 & La seconde action que doit réaliser le testeur 
              & Ce que le logiciel doit fournir comme résultat 
